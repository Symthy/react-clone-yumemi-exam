...
// export const mockPrefecturesApiHandler = rest.get(RESAS_API_ENDPOINT + RESAS_API_PREFECTURES_PATH, serverError);
// export const mockPopulationsApiHandler = rest.get(RESAS_API_ENDPOINT + RESAS_API_POPULATIONS_PATH, serverError);
